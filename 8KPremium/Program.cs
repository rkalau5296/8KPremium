...
//Console.WriteLine(pangram.IsPangramVer2("The quick brown fox jumps over the lazy dog"));
//Console.WriteLine(pangram.IsPangramVer2("I am programmer"));
//Console.WriteLine(pangram.IsPangramVer2("abcdefghijklmnoqprstuvwxyz"));
